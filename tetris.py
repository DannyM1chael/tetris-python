...
# настраиввем глобальные переменные
# функции
# - create_grid (создаем сетку)
# - draw_grid (отображаем сетку)
# - draw_window (отображаем окно игры)
# - rotating shape in main (меняем положение фигур)
# - setting up the main (настройка главного меню)
